    ...
    roundPostHeights.map(({ value, price }) => {
      ...
      return [
        id,
        {
          ...
          image: color.image,
          description: `Plotový sloupek PVC Ø48 mm, výška ${value} mm, ${color.labelLower} provedení, s ucpávkou. Vhodný pro stavbu pletivového plotu.`,
          price: `${priceValue},-`,
    ...
    braceHeights.map(({ value, greenPrice, anthracitePrice }) => {
      ...
      return [
        id,
        {
          ...
          description: `Plotová vzpěra PVC Ø38 mm, délka ${value} mm, ${color.labelLower} provedení, s kompletním spojovacím materiálem - krytkou a objímkou. Vhodná pro zpevnění pletivového plotu.`,
          price: `${priceValue},-`,
          link: `/PlotoveSloupky/${id}`,
        },
      ];
