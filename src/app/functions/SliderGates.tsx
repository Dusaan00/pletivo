...
interface SliderGatesProps {
  children: React.ReactNode;
}

const SliderGates: React.FC<SliderGatesProps> = ({ children }) => {
  ...
  return (
    <div
      className="slider-gates-wrapper"
      style={{
    ...
    >
      <div className="slider-gates-viewport">
        <div
          className="slider-gates-inner"
          ref={sliderRef}
          style={{
            display: "flex",
