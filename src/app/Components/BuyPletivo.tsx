      ...
      <section className="section-spletivo">
        ...
        <div className="section-spletivo-container">
          ...
          <div className="section-spletivo-product">
            <ColorChange
              availableDescription="Produkt můžete jednoduše vložit do košíku a objednávku dokončit online. Případně nám můžete zavolat nebo napsat email."
              unavailableDescription="Produkt bude možné objednat online po naskladnění. Případně nám můžete zavolat nebo napsat email."
            >
              <p>
